...
if(isset($_POST['editar'])) {
    $produto = new Produto($_POST['id'], $_POST['tipo'],$_POST['nome'], $_POST['descricao'], $_POST['preco'], $_FILES['imagem']['full_path']);

    $produtoRepository->alteraDadosProduto($produto);
...
<main>
  ...
  <section class="container-form">
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="text" id="preco" name="preco" value="<?= number_format($produto->getPreco(), 2)?>" required>
